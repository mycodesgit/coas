...
Route::group(['middleware' => 'auth.user'], function(){
    ...
    Route::prefix('emp/admission')->group(function () {
        ...
        Route::prefix('examinee')->group(function () {
            ...
            Route::get('/examineeListData', [ExamineeController::class, 'examineeListData'])->name('examineeListData');
            ...
            Route::get('/examineeListSearchData', [ExamineeController::class, 'examineeListSearchData'])->name('examineeListSearchData');
