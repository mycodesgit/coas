                ...
                <div class="col-lg-5 col-md-12 col-sm-12 logo">
                    ...
                    <div class="row">
                        <div class="col-lg-offset-2 col-md-offset-1 col-sm-offset-1 col-xs-offset-1 col-lg-8 col-sm-10 col-xs-10">
                            ...
                            <a href="" type="button" class="btn btn-warning btn-block" style="border-radius: 0"> <h5 class="mb-1">Application Closed</h5></a>
                            <a href="<?php echo e(URL::route('admission-track')); ?>" type="button" class="btn btn-warning btn-block" style="border-radius: 0"> <h5 class="mb-1">Track Admission</h5></a>
...
</html><?php /**PATH C:\xampp\htdocs\coas\resources\views/portal/index.blade.php ENDPATH**/ ?>