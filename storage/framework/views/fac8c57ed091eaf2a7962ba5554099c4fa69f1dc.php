            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td style="text-align:center;">
                    <a data-toggle="tooltip" data-placement="bottom" title="Process Applicant"><i id="<?php echo e($applicant->id); ?>" data-toggle="modal" data-target="#info_app" class="btn btn-green glyphicon glyphicon-tasks info_applicant"></i></a>
                  </td>
                </tr> 
                <?php else: ?>
                <?php endif; ?>
...
<?php $__env->stopSection(); ?>
 ...
 <!-- Start Applicant -->
  ...
  <!-- End  Applicant -->
<?php echo $__env->make('layouts.master_admission', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u841447435/domains/cpsucoas.com/public_html/resources/views/admission/applicant/list_search.blade.php ENDPATH**/ ?>