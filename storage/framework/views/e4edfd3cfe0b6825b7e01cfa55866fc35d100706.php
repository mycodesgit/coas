      ...
      <div class="container col-lg-offset-2 col-md-offset-3 col-lg-8 col-md-6 login-center bg-inputs">
          ...
          <div class="row ads">
            ...
            <div class="col-lg-5 logo">
              <div class="row">
                <a href="<?php echo e(URL::route('home')); ?>"><img src="<?php echo e(asset('dist/img/logo.png')); ?>"></a>
              </div>
...
<script src="<?php echo e(asset('bootstrap/js/bootstrap.min.js')); ?>"></script>  
      ...
      <?php /**PATH C:\xampp\htdocs\coas\resources\views/errors/500.blade.php ENDPATH**/ ?>