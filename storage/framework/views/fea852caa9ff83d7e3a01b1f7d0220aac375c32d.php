       ...
       <?php echo e(csrf_field()); ?>
        ...
        <div class="row"> 
          <div class="col-md-12">
            ...
            <h4>Search Results:  <small><i>Year-, Campus-, ID-,  Strand-, Lastname-</i></small></h4>
          </div>
          </div>
        </div>
    </form>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master_admission', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\coas\resources\views/admission/examinee/result_list.blade.php ENDPATH**/ ?>