                                    ...
                                    <div class="timeline-panel">
                                        <div class="timeline-heading">
                                            <div class="timeline-title">
                                                ...
                                                <h6><i>Date: <?php echo e($applicant->created_at->format('m-d-Y')); ?></i></h6>
                                            </div>
                                        </div>
                                        ...
                                        <div class="timeline-panel">
                                            <div class="timeline-heading">
                                                <div class="timeline-title">
                                                    ...
                                                    <h5>Result is out!</h5>
                                                    <!--<h6 style="text-indent: 50px;"><i><b>Raw Score</b>: <?php echo e($applicant->result->raw_score); ?></i></h6>-->

                                                    <h6 style="text-indent: 50px;">
                                                        <i>
                                                            <b>Percentile</b>: <?php echo e($applicant->result->percentile); ?>
                                                    ...
                                                    <h6 style="text-indent: 50px;">
                                                        <i>
                                                            <b>Remark</b>: 
                                                            <?php if($applicant->result->percentile <= 25): ?>  FAILED 
                                                                <?php else: ?> PASSED 
                                                            <?php endif; ?>
                                                        </i>
                                                    </h6>
                                                    <h5 style="text-indent: 50px;">
                                                        <b>
                                                            <?php if($applicant->result->percentile <= 25): ?>  NOT QUALIFIED TO ENROLL 
                                                                <?php else: ?> QUALIFIED TO ENROLL 
                                                            <?php endif; ?>
                                                        </b>
                                                    </h5>
                                                    <h6 style="text-indent: 50px;">
                                                        <i>
                                                            <?php if($applicant->result->percentile <= 25): ?>  
                                                                <?php else: ?> * Subject to College Screening Process 
                                                            <?php endif; ?>
                                                        </i>
                                                    </h6>
...
</html><?php /**PATH C:\xampp\htdocs\coas\resources\views/portal/track.blade.php ENDPATH**/ ?>