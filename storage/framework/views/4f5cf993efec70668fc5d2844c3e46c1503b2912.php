...
<div class="row">
    ...
    <form method="GET" action="<?php echo e(route('srchexamineeList')); ?>">
        ...
        <div class="container-fluid">
            ...
            <h4>
                Search Results: <?php echo e($totalSearchResults); ?> <small><i>Year-<b><?php echo e(request('year')); ?></b>, Campus-<b><?php echo e(request('campus')); ?></b>, ID-<b><?php echo e(request('admission_id')); ?></b>,  Strand-<b><?php echo e(request('strand')); ?></b></i></small>
            </h4>
        </div>
    </form>
    <div class="container-fluid">
...
<?php echo $__env->make('layouts.master_admission', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\coas\resources\views/admission/examinee/list_search.blade.php ENDPATH**/ ?>