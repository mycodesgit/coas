    ...
    $(document).ready(function () {
        function initializeDataTable() {
            $('#applicant-list').DataTable({
                ajax: {
                    url: '/your-route-url', // Replace with the URL of your route/controller method
        ...
        function refreshDataTable() {
            $('#applicant-list').DataTable().ajax.reload(null, false); // Reload the table without resetting the current page
        }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master_admission', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\coas\resources\views/admission/examinee/result_search.blade.php ENDPATH**/ ?>