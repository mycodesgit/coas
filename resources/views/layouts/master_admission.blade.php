    ...
    <div class="container-fluid" style="margin-top: 65px;">
        <div class="sidebar-menu col-md-2">
            ...
            <ul class="list-group">
                ...
                <a href="{{ route('examinee-confirm') }}" class="list-group-item">Confirmed Applicants</a>
                <a href="{{ route('applicant-accepted') }}" class="list-group-item">Accepted Applicants</a>
                <a href="{{ route('slots') }}" class="list-group-item">Availability/Slots</a>
                <a href="{{ route('configure_admission') }}" class="list-group-item">Configure Admission</a>
            </ul>
            <div class="page-header">
                Reporting
            </div>
            <ul class="list-group">
                ...
                <a href="{{ route('schedules_printing') }}" class="list-group-item">Admission Schedules</a>
                ...
                <a href="{{ route('confirm_printing') }}" class="list-group-item">Confirmed Applicants</a>
        ...
        <script type="text/javascript">
          ...
          $(document).ready(function () {
            ...
            var table = $('#applicant-list').DataTable({
                ...
                "autoWidth": false,
                ajax: {
                    url: "{{ route('examineeListSearchData') }}",
                    type: "GET",
                    dataType: "json",
                    data: function (d) {
