...
<html lang="en">
  ...
  <div class="container-fluid" style="margin-top: 65px;">
    ...
    <div class="row">
      ...
      <form method="GET" action="{{ route('admission-track-status') }}">
       {{ csrf_field() }}
        <div class="row"> 
          <div class="col-md-12">
            ...
            <div class="col-md-2">
              <button type="submit" class="form-control btn btn-green hidden-sm hidden-xs">Search</button>
              <button type="submit" class="form-control btn btn-green hidden-lg hidden-md" style="margin-top: 10px;">Search</button>
            </div>
            ...
            <div class="well well-sm" style="border:2px solid #04401f;">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-8">
                        ...
                        <h4>Admission ID: <span id="p1">{{ old('admissionid') }}</span></h4>
                        <h5>Name: {{ old('firstname')}} {{ old('mname') }} {{ old('lastname') }}</h5>
                        <h5>Preferred Campus: @if (old('campus') == 'MC') Main @elseif(old('campus') == 'SCC') San Carlos @elseif(old('campus') == 'VC') Victorias @elseif(old('campus') == 'HC') Hinigaran @elseif(old('campus') == 'MP') Moises Padilla @elseif(old('campus') == 'HinC') Hinobaan @elseif(old('campus') == 'SC') Sipalay @elseif(old('campus') == 'IC') Ilog @elseif(old('campus') == 'CC') Cauayan @endif</h5>
                        <h5>Date of Birth: {{ old('bday')}}</h5>
                        <h5>Email Address: {{ old('email')}}</h5>
                        <h5>Contact: {{ old('contact')}}</h5>
                        <h5>Present Address:{{ old('address')}}</h5>
                    </div>
                </div>
            </div>
          </div>
