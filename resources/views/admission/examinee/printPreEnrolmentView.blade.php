...
@section('workspace')
    <ol class="breadcrumb">
        ...
        <li style="text-transform: uppercase;">{{$examinee->fname}} @if($examinee->mname == null) @else {{ substr($examinee->mname,0,1) }}.@endif {{$examinee->lname}}  @if($examinee->ext == 'N/A') @else{{$examinee->ext}}@endif</a></li>
