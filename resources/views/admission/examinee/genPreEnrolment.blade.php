...
<body>
	<div class="container">
	    ...
	    <div class="name">
	    	...
	    	<div class="name-p-c"><b>{{$examinee->fname}} @if($examinee->mname == null) @else {{ substr($examinee->mname,0,1) }}.@endif {{$examinee->lname}}  @if($examinee->ext == 'N/A') @else{{$examinee->ext}}@endif</b></div>
	    	...
	    	<div class="result">
	    		...
	    		<div class="name-p" style="margin-left: 8px;text-decoration: underline;">{{$examinee->d_admission}}</div>
	    		<div class="name-p" style="margin-left: 10px;">Test Venue:</div>
	    		<div class="name-p" style="text-decoration: underline;">{{$examinee->venue}}</div>
	    		<div class="name-p" style="margin-left: 0px;">Raw Score:</div>
	    		<div class="name-p" style="text-decoration: underline;">{{$examinee->result->raw_score}}</div>
	    		<div class="name-p" style="margin-left: 0px;">Percentile:</div>
	    		<div class="name-p" style="margin-left: 0px;text-decoration: underline;">{{$examinee->result->percentile}}</div>
	    	</div>
	    </div>
	 	...
	 	<br>	
	      ...
	      <ul style="list-style-type: none;margin: 0;padding: 0;font-size: 10px;">
		      <li><input type="checkbox" class="checkbox" value="BSAB" {{ old('type', $examinee->interview->course) === 'BSAB' ? 'checked' : '' }}><span> Bachelor of Science in Agricultural Business (BSAB)</span></li>
	      ...
	      <ul style="list-style-type: none;margin: 0;padding: 0;font-size: 10px;">
		      ...
		      <li><input type="checkbox" class="checkbox" value="BASS" {{ old('type', $examinee->interview->course) === 'BASS' ? 'checked' : '' }}> <span> Bachelor of Arts in Social Science (BASS)</span></li>
	      </ul>
	      ...
	      <div class="name-p" style="font-size: 12px;margin-left:104px;">Date: <span style="text-decoration: underline;">{{$examinee->interview->created_at->format('Y-d-m') }}</span></div>
	      <br />
