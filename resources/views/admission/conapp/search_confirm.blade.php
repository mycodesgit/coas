       ...
       <thead>
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td><small><span>@if ($applicant->interview->remarks == 1) Accepted for Enrolment @else Not accepted for enrolment @endif</span></small></td>
                  <td>{{ $applicant->interview->course }}</td>
                  <td style="text-align:center;">
                    <a data-toggle="tooltip" data-placement="bottom" title="Process Applicant"><i id="{{ $applicant->id }}" data-toggle="modal" data-target="#info_app" class="btn btn-green info_applicant glyphicon glyphicon-tasks"></i></a>
                  </td>
                </tr> 
                @else
                @endif
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <div class="modal-body">
            ...
            <p><a href="#" type="button" class="btn btn-green glyphicon glyphicon-stats" id="btn_dept_interview"></a> Process Pre-Enrolment</p>
            <p><a href="#" type="button" class="btn btn-green glyphicon glyphicon-print" id="btn_view_preenrolment"></a> Generate Pre-Enrollment</p>
            <p><a href="#" type="button" class="btn btn-green glyphicon glyphicon-check" id="btn_accepted_applicants"></a> Accept Applicant</p>  
            @else
            <p><a href="#" type="button" class="btn btn-green glyphicon glyphicon-print" id="btn_view_preenrolment"></a> Generate Pre-Enrollment</p>
            <p><a href="#" type="button" class="btn btn-green glyphicon glyphicon-check" id="btn_accepted_applicants"></a> Accept Applicant</p>  
            @endif  
